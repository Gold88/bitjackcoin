#ifndef BITJACKCOINUNITS_H
#define BITJACKCOINUNITS_H
...
/** Bitjackcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for dropdown selection boxes.
*/
class BitjackcoinUnits: public QAbstractListModel
{
public:
    explicit BitjackcoinUnits(QObject *parent);
...
typedef BitjackcoinUnits::Unit BitjackcoinUnit;

#endif // BITJACKCOINUNITS_H
